...
class Protocol512CounterfactualClosureTests(unittest.TestCase):
    ...
    def test_existing_relation_helpers_reject_direct_inversions(self) -> None:
        cases = (
            ...
            (mode_r_holds, "Normative design change is not predetermined; Design may keep frozen semantics and require consolidation, refactoring, or canonicalization.", "A normative design revision is always required."),
